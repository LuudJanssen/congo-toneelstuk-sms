...
numberChunks.forEach(numberSet => {
  ...
  const body =
    "Hey KittyFit gebruiker! We zien dat je vrienden hard aan het sporten zijn. Wil je de prestaties van je vrienden gisteravond bekijken? https://bit.ly/2LcVhf5";
